...
int getUniqNumber()
{
    ...
    while (!uniq)
    {
        ...
        {
            int countUniq = GetNumbersOfUnuq(numbers);
...
int GetNumbersOfUnuq(int [] numbers)
{
    int result = new int();
...
void print3DArray(int[,,] arrayToPrint, int oneLineLegth = 5)
{
    int currentLength = 0;
